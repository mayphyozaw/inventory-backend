document.addEventListener("DOMContentLoaded", function () {
                    ...
                    data.forEach((product) => {
                        let item = `
                                <a href="#" 
                                    ...
                                    <i class="fas fa-text-search me-2"></i>
    ...
    function addProductToTable(productElement) {
        ...
        //Check if the product already exist in the table
            ...
            <tr data-id = "${productId}">
                ...
                <td>
                    <input type="number" class="form-control discount-input"
                            name="products[${productId}][discount]" value="0" min="0" 
                            style="width:100px;">
                </td>
    ...
    function updateGrandTotal() {
        ...
        //Add discount and add shipping cost
        grandTotal = grandTotal - discount + shipping;

        // Ensure grandTotal is not a negative
        if (grandTotal < 0) {
            grandTotal = 0;
        }
