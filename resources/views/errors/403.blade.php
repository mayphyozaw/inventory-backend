                        ...
                        <div class="text-center">
                            <div class="mb-5 text-center">
                                <a href="index.html" class="auth-logo">
                                    <img src="{{asset('data/logo.png')}}" alt="logo-dark" class="mx-auto" height="60" />
                                </a>
                            </div>
                            ...
                            <div class="text-center">
                                <h3 class="mt-5 fw-semibold text-black text-capitalize">Oops!, You don't have any permission access.</h3>
