...
@section('admin')
        ...
        <div class="container-xxl">
            ...
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                <div class="flex-grow-1">
                    <h4 class="fs-18 fw-semibold m-0">Update Brand</h4>
                </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="row g-3" action="{{ route('brand.update', $brand->id) }}" method="post" enctype="multipart/form-data" id="submit-form">
                                @csrf
                                @method('PUT')
                                <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img id="showImage"
                                        src="{{ !empty($brand->image) ? url('upload/brand_images/' . $brand->image) : url('upload/no_image.jpg') }}"
    ...
    @push('scripts')
        {!! JsValidator::formRequest('App\Http\Requests\Brand\BrandUpdateRequest', '#submit-form') !!}
    @endpush
@endsection
