<x-edit-button href="{{ route('purchase.show', $purchase->id) }}" class="btn btn-warning btn-sm" title="Details">
    <i class="fa fa-eye"></i>
</x-edit-button>
...
@if(Auth::guard('web')->user()->can('edit_purchase'))
...
@if(Auth::guard('web')->user()->can('delete_purchase'))
