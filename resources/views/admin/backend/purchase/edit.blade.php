            ...
            <div class="container-fluid my-0">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('purchase.update', $editPurchaseData->id) }}" method="post"
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="warehouse_id" value="{{$editPurchaseData->warehouse_id}}">
                                                ...
                                                <select name="warehouse_id" id="warehouse_id"
                                                    ...
                                                    @foreach ($warehouses as $item)
                                                        <option value="{{ $item->id }}"
                                                            {{ $item->id === $editPurchaseData->warehouse_id ? 'selected' : '' }}>
                                                            {{ $item->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group w-100">
                                                ...
                                                <select name="supplier_id" id="supplier_id" class="form-control form-select">
                                                    ...
                                                    @foreach ($suppliers as $item)
                                                        <option value="{{ $item->id }}"
                                                            {{ $item->id === $editPurchaseData->supplier_id ? 'selected' : '' }}>
                                                            {{ $item->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <table class="table table-striped table-bordered dataTable" style="width: 100%;">
                                            ...
                                            <tbody id="productBody">
                                                @foreach ($editPurchaseData->purchaseItems as $item)
                                                    <tr data-id={{ $item->id }}>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="py-3" id="displayDiscount">
                                                                    TK {{ $editPurchaseData->discount }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="py-3">Shipping</td>
                                                                <td class="py-3" id="shippingDisplay">
                                                                    TK {{ $editPurchaseData->shipping }}</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="py-3 text-primary">Grand Total</td>
                                                                <td class="py-3 text-primary" id="grandTotal">
                                                                    TK {{ $editPurchaseData->grand_total }}</td>
                                                                <input type="hidden" name="grand_total" value="{{$editPurchaseData->grand_total }}">
                                                            </tr>
                                        ...
                                        <div class="form-group w-100">
                                            ...
                                            <select name="status" id="status" class="form-control form-select">
                                                ...
                                                <option value="Received"
                                                    {{ $editPurchaseData->status === 'Received' ? 'selected' : '' }}>
                                                    Received</option>
                                                <option value="Pending"
                                                    {{ $editPurchaseData->status === 'Pending' ? 'selected' : '' }}>Pending
                                                </option>
                                                <option value="Ordered"
                                                    {{ $editPurchaseData->status === 'Ordered' ? 'selected' : '' }}>Ordered
                                                </option>
                                            </select>
                                            @error('status')
                                                <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="col-md-12 mt-2">
                                    ...
                                    <textarea class="form-control" name="note" rows="3" placeholder="Enter Notes">{{ $editPurchaseData->note }} </textarea>
                                </div>
                            </div>
                    </div>
                </div>
