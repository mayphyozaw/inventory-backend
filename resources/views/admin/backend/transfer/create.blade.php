            ...
            <div class="container-fluid my-0">
                <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                    <div class="flex-grow-1">
                        <h4 class="fs-18 fw-semibold m-0">Create Transfer</h4>
                    </div>
                    <div class="text-end">
                        <ol class="breadcrumb m-0 py-0">
                            <a href="{{ route('transfer.index') }}" class="btn btn-dark">Back</a>
                        </ol>
                    </div>
                </div>
                        ...
                        <form action="{{ route('transfer.store') }}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="col-xl-12">
                                <div class="d-flex mt-5 justify-content-end">
                                    ...
                                    <a class="btn btn-secondary" href="{{ route('transfer.index') }}">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
